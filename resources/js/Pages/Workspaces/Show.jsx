                ...
                <div className="mt-8 flex w-full flex-col justify-start gap-x-5 gap-y-8 sm:flex-row">
                    {statuses.map((status, index) => (
                        <div className="w-full space-y-4 sm:w-1/4" key={index}>
                            ...
                            {/* Colum Card Container */}
                            <div className="flex flex-grow flex-col gap-4 overflow-hidden overflow-y-auto p-2">
                                {cards
                                    ...
                                    .map((card, index) => (
                                        ...
                                        >
                                            <CardHeader>
                                                ...
                                                <CardDescription className='leading-relaxed tracking-tighter line-clamp-4'>
                                                    {card.description}
                                                </CardDescription>
                                            </CardHeader>
                                        </Card>
